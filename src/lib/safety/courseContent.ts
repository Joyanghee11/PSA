...
const chapter1Slides: Slide[] = [
  ...
  },
  {
    ...
    footnote: "본 교육의 핵심 의무는 제3장(안전관리규정)에 집중되어 있습니다.",
  },
  {
    id: "ch1-keyContents",
    type: "grid",
  ...
  },
  {
    ...
    intro: "연안체험활동을 모집·운영하려는 자는 활동 14일 전까지 관할 해양경찰서장에게 신고해야 합니다.",
    bullets: [
  ...
  },
  {
    ...
    type: "flow",
    title: "신고처리 절차 (계획 신고)",
    intro: "온라인(https://imsm.kcg.go.kr) 또는 방문 신고. 활동 14일 전 접수가 원칙입니다.",
    steps: [
      { label: "운영계획 수립", actor: "운영자", detail: "인원·장소·일자 등 계획" },
      { label: "계획 신고", actor: "운영자", detail: "모집 14일 전 온라인 시스템으로 접수" },
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: "q2-2",
        q: "연안체험활동 사전신고는 활동 며칠 전까지 해야 하는가?",
        choices: ["7일 전", "10일 전", "14일 전", "30일 전"],
        correctIndex: 2,
        explanation: "「연안사고예방법 시행규칙」 제7조 — 활동 14일 전까지 관할 해양경찰서장에게 신고.",
      },
      {
        id: "q2-3",
        q: "신고 제외 대상이 아닌 것은?",
  ...
  },
  {
    ...
    items: [
      "활동 14일 전까지 관할 해양경찰서에 사전 신고 (계획·기간별·건별 중 적합한 종류 선택)",
...
const addendumSlides: Slide[] = [
  ...
  },
  {
    ...
    title: "본 부록의 취지",
    intro:
      "본 교재 본문은 2019년 발간본을 기준으로 합니다. 발간 이후 시행된 주요 관련법령의 변동을 별도로 안내하며, 본문과 충돌하는 내용은 본 부록을 우선합니다.",
    bullets: [
      { lead: "ⓘ", text: "본 부록은 학습 안내용 요약입니다. 실제 법률 적용·인허가·신고 시에는 「국가법령정보센터」 또는 소관 부처(해양수산부·해양경찰청) 게시 현행 조문을 반드시 확인하십시오." },
      { lead: "🔗", text: "각 슬라이드 하단의 [참고] 링크는 해당 법령의 공식 정보 페이지로 연결됩니다." },
      { lead: "🔄", text: "운영자는 본 부록을 정기적으로 검토·갱신해야 합니다." },
    ],
    reference: { kr: "국가법령정보센터", url: "https://www.law.go.kr/" },
  },
  {
    id: "addendum-coastal",
    type: "bullets",
    title: "1. 연안사고 예방에 관한 법률",
    intro:
      "「연안사고 예방법」은 2014년 제정·시행 이후 안전관리계획·체험활동 신고의무·운영자 자격기준 등을 중심으로 수 차례 개정되었습니다.",
    bullets: [
      { lead: "사전신고", text: "신고 임계인원·신고 기한·서식은 시행령·시행규칙 개정으로 변동될 수 있으므로 매 시즌 시작 전 반드시 확인" },
      { lead: "출입통제", text: "해경청장이 지정·고시하는 위험구역 범위는 갱신될 수 있음 — 활동 전 「해양경찰청 안전정보」 또는 관할 해경서 조회" },
      { lead: "요원 배치", text: "활동 유형·체험자 인원에 따른 배치 인원수 산정기준이 강화된 사례 — 시행규칙 별표를 통해 현행 비율 확인" },
      { lead: "벌칙", text: "신고 누락·허위 신고·안전수칙 위반에 대한 과태료 한도가 상향되었을 수 있음" },
    ],
    reference: {
      kr: "법령정보 — 연안사고 예방에 관한 법률",
  ...
  },
  {
    ...
    type: "bullets",
    title: "2. 수중레저활동의 안전 및 활성화 등에 관한 법률 (수중레저법)",
    intro:
      "「수중레저법」은 2016년 제정, 2017년 시행 이후 다수 개정되었습니다. 본 교재의 4장 「Ⅱ. 잠수관련 법률」은 핵심을 다루지만 신고대상·자격기준·교육이수·보험 등은 갱신 사항을 별도 확인해야 합니다.",
    bullets: [
      { lead: "사업등록", text: "수중레저사업(렌탈·교육·체험)은 관할 시·군·구청에 등록 필요. 등록기준(인적·시설·장비) 시행령 수시 점검" },
      { lead: "안전수칙", text: "본 법 제18조 및 시행규칙 — 음주 금지, 안전장비 의무, 사고 즉시 신고. 음주 측정·확인 절차 강화 가능성" },
      { lead: "안전요원", text: "본 법 제20조 — 자격요건·유효기간·보수교육 주기 시행규칙 별표가 갱신될 수 있음. 본 교육 이수 주기(통상 매 2년) 확인" },
      { lead: "보험", text: "사업자는 참가자 책임보험 가입 의무 — 보장 한도 상향 가능성" },
      { lead: "정책", text: "해양레저관광 진흥계획 연계 — 일부 지원·표준약관 도입" },
    ],
    reference: {
      kr: "법령정보 — 수중레저법",
      url: "https://www.law.go.kr/lsSc.do?menuId=1&query=%EC%88%98%EC%A4%91%EB%A0%88%EC%A0%80",
    },
  },
  {
    ...
    items: [
      "□ 연안체험활동 사전신고서 제출 (관할 해양경찰서)",
      "□ 수중레저사업 등록증·변경등록 사항 최신화",
      "□ 안전관리요원·강사 자격 유효기간 확인",
      "□ 책임보험 가입증서 비치 (가입 한도 현행 기준 충족)",
    ...
    footnote: "본 체크리스트는 변경 가능. 매 분기 갱신하시기 바랍니다.",
  },
];
