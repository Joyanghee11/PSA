...
# 이 스크립트는 Claude Code 터미널에서 직접 실행하세요:
#   powershell -File C:\Users\joyan\PSA\scripts\generate-news.ps1
# =====================================================
