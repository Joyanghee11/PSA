...
claude -p "프리다이빙 관련 유튜브 영상 1개를 찾아서 소개하는 기사를 작성해줘. 조건: 1) 더블케이(Double K), 패디(PADI) 채널 절대 제외. 2) 기존 content/articles/ 폴더의 video 카테고리와 중복 안되게. 3) 반드시 curl로 https://www.youtube.com/oembed?url=https://www.youtube.com/watch?v=영상ID&format=json 확인하여 HTTP 200인 것만 사용. 200 아니면 다른 영상 찾아. 4) 본문에 유튜브 임베드: <div style='position:relative;padding-bottom:56.25%%;height:0;overflow:hidden;max-width:100%%;margin:1.5rem 0'><iframe src='https://www.youtube.com/embed/영상ID' style='position:absolute;top:0;left:0;width:100%%;height:100%%;border:0' allowfullscreen></iframe></div> 5) imageUrl: https://img.youtube.com/vi/영상ID/maxresdefault.jpg 6) category: video. content/articles/의 오늘 날짜 폴더에 저장." --allowedTools "Bash,Read,Write,Edit" --max-turns 15
